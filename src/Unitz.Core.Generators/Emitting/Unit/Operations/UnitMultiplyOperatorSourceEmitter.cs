...
internal class UnitMultiplyOperatorSourceEmitter() : BaseUnitOperatorSourceEmitter(OperationKind.Multiply)
{
    ...
    {
        codeWriter.WriteLine($"global::System.Numerics.IMultiplyOperators<{unitTypeReference}, {QuantityNameProvider.UnitReference(operationModel.Operand, valueTypeReference)}, {QuantityNameProvider.UnitReference(operationModel.Result, valueTypeReference)}>");
    }
}
